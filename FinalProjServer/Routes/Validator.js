...
// Custom method to make sure a given body only contains certain fields
Validator.prototype.hasOnlyFields = function(body, fieldList) {
   var self = this;
   body.forEach(function(fName) {
      self.chain(fieldList.indexOf(fName) !== -1, 
      Validator.Tags.forbiddenField, [fName])
   });
   return this;
};
